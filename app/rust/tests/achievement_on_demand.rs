...
use memolanes_core::{
    achievement::{on_demand::OnDemandStore, scope::AchievementLayer, store::AchievementStore},
    geo::GeoIndex,
...
fn read_on_demand(
    ...
    [u64; 3],
    memolanes_core::achievement::region_index::RegionStateMap,
) {
    storage
